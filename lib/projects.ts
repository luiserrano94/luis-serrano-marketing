...
export const PROJECTS: Project[] = [
  {
    ...
    rows: [
      ...
      { cols: "1fr 1fr 0.6fr", cells: [{ g: 2 }, { g: 3 }, "rail"] },
    ],
  },
  {
    slug: "pacific",
  ...
  },
  {
    ...
    // display order gives numbered captions 01..07 in reading order, each on
    // the matching scene: g5 tray(01) g3 motion(02) g2 pour(03) / g6 couple(04)
    // g1 piano(05) g0 toast(06) g4 pour(07). g7 banquette unused.
    rows: [
  ...
  },
  {
    ...
    // g0 leopard(02) g2 peacock(03) / g3 fox(04) g1 ostrich(05). g4 zebra=cover.
    rows: [
