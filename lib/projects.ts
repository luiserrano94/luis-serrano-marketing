...
// `feature` renders a full-width image (height-capped, centered). Images always
// render at intrinsic ratio (height:auto) — never cropped.
export type Cell = "concept" | "rail" | { g: number; feature?: boolean };
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { cols: "1fr 1fr 1fr", cells: [{ g: 3 }, { g: 4 }, { g: 5 }] },
      { cols: "1fr 1fr", cells: [{ g: 6 }, { g: 7 }] },
    ],
  },
  {
    slug: "afterdark",
    ...
    // g2 pour(03) / g6 couple(04) g1 piano(05) g0 toast(06) g4 pour(07). g7 banquette
    // = same shot as the hero, shown full-width as a closing frame (uncaptioned).
    rows: [
      { cols: "1.3fr 1fr 1fr 1fr", cells: ["concept", { g: 5 }, { g: 3 }, { g: 2 }] },
      { cols: "1fr 1fr 1fr 1fr", cells: [{ g: 6 }, { g: 1 }, { g: 0 }, { g: 4 }] },
      { cols: "1fr", cells: [{ g: 7, feature: true }] },
    ],
  },
  {
    slug: "animalprint",
    ...
    // g0 leopard(02) g2 peacock(03) / g3 fox(04) g1 ostrich(05). g4 zebra = same
    // shot as the hero, shown full-width as a closing frame (uncaptioned).
    rows: [
      { cols: "1.2fr 1fr 1fr", cells: ["concept", { g: 0 }, { g: 2 }] },
      { cols: "1fr 1fr", cells: [{ g: 3 }, { g: 1 }] },
      { cols: "1fr", cells: [{ g: 4, feature: true }] },
    ],
  },
];
